...
Kaseki is an SSH Brute Force Testing tool designed to help security professionals assess the security of SSH servers. It allows you to test multiple usernames and password combinations in a configurable and multithreaded manner.
...
--procs: Number of processes to use (default is 0, which means no multiprocessing).
